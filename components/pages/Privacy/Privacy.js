...
export default function Privacy() {
    return (
        <div className={classes.Privacy}>
            ...
            <p>На этой странице Вы можете ознакомиться с Политикой конфиденциальности ООО «СГ РИСАН» (далее – «мы», «нам», «наш», «нас») в отношении персональной информации, которую мы можем получать посредством сети Интернет во время использования Вами веб-сайта risan-penza.ru и всех его поддоменов (далее – Сайт) и предоставляемых на Сайте сервисов, продуктов или услуг (далее – Сервисы).</p>
            ...
            <h3>1. Согласие с Политикой конфиденциальности</h3>

            <p>Ваше обращение к Сайту означает Ваше безоговорочное согласие с данной Политикой конфиденциальности и указанными в ней условиями обработки Вашей персональной информации. В случае несогласия с этими условиями Вы должны воздержаться от использования Сайта и покинуть его.</p>


            <h3>2. Интеллектуальная собственность и права на использование</h3>
            ...
            <h3>3. Применимое законодательство</h3>
            ...
            <h3>4. Персональная информация</h3>

            <p>Информация, которую мы вправе собирать о Вас, зависит от того, как Вы используете возможности, предоставленные нашим Сайтом.</p>
            ...
            <h3>5. Цели обработки персональной информации</h3>
            ...
            <p>Мы вправе обрабатывать собранную персональную информацию в следующих целях:</p>

            <ul>
                <li>для идентификации, авторизации и аутентификации Вас в качестве пользователя нашего Сайта;</li>

                <li>для предоставления Вам персонализированных Сервисов; o Для исполнения Договоров, заключенных в Вами;</li>
            ...
            <h3>6. Рекламная информация и маркетинговые материалы. Отказ от участия</h3>

            <p>В дополнение к обозначенным целям обработки персональной информации мы хотели бы информировать Вас о новостях, рекламных акциях и специальных предложениях, которые могут быть выгодными для Вас. Мы ценим Ваше время и внимание, поэтому контролируем рассылку рекламной информации и маркетинговых электронных писем.</p>

            <p>Сайт предоставляет Вам возможность отказаться от участия в рассылке таких материалов путем перехода по ссылке, указанной в полученном Вами письме, или выбрав иной доступный способ отказа от рассылки. Вы также можете изменить Ваши настройки для получения или неполучения маркетинговых электронных писем или обновить их.</p>
            ...
            <h3>10. Меры, применяемые для защиты персональной информации</h3>
            ...
            <h3>13. Обратная связь. Вопросы и предложения:</h3>

            <p>Мы приветствуем Ваши комментарии о работе Сайта, нашей деятельности и нашей Политике конфиденциальности. Любые вопросы или предложения можно присылать на адрес электронной почты: info@risan-penza.ru</p>
            ...
            <p>ИНН/КПП: 5836658514 / 583601001</p>

            <p>Юр. адрес: 440008, г. Пенза, ул. Пушкина, 15</p>

            <p>Р/C 40702810548000016774</p>

            <p>В ПАО &quot;Сбербанк&quot; г. Пенза К/C 30101810000000000635 БИК 045655635</p>
        </div>
    )
}